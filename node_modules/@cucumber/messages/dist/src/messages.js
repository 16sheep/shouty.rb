    ...
    io.cucumber = (function() {
        ...
        cucumber.messages = (function() {
            ...
            messages.Attachment = (function() {
                 ...
                 * @property {string|null} [body] Attachment body
                 * @property {string|null} [mediaType] The media type of the data. This can be any valid
                 * [IANA Media Type](https://www.iana.org/assignments/media-types/media-types.xhtml)
                 * as well as Cucumber-specific media types such as `text/x.cucumber.gherkin+plain`
                 * and `text/x.cucumber.stacktrace+plain`
                 * @property {io.cucumber.messages.Attachment.ContentEncoding|null} [contentEncoding] Content encoding is *not* determined by the media type, but rather by the type
